...
<div class="container mx-auto p-8">
    ...
    <form action="{{ route('products.store') }}" enctype="multipart/form-data" method="POST"  class="space-y-4 text-white">
        ...
        <div class="flex flex-col text-black">
            ...
            <input type="text" name="name" id="name"  class="mt-1 p-2 border border-gray-300 rounded-md focus:ring focus:ring-blue-200">
        </div>

        <div class="flex flex-col text-black">
            <label for="description" class="text-sm font-semibold text-white">Descrizione</label>
            <input type="text" name="description" id="description"  class="mt-1 p-2 border border-gray-300 rounded-md focus:ring focus:ring-blue-200">
        </div>
